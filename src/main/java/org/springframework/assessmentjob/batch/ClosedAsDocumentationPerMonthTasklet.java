 ...
 */
@Component public class ClosedAsDocumentationPerMonthTasklet extends BaseGithubSearchTasklet {

    public ClosedAsDocumentationPerMonthTasklet(RestOperations restTemplate, Map<ReportKey, List<Long>> report,
