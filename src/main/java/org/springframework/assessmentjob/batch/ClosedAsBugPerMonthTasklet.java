 ...
 */
@Component public class ClosedAsBugPerMonthTasklet extends BaseGithubSearchTasklet {

    public ClosedAsBugPerMonthTasklet(RestOperations restTemplate, Map<ReportKey, List<Long>> report,
