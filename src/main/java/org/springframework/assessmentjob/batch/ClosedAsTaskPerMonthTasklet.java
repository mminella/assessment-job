 ...
 */
@Component public class ClosedAsTaskPerMonthTasklet extends BaseGithubSearchTasklet {

    public ClosedAsTaskPerMonthTasklet(RestOperations restTemplate, Map<ReportKey, List<Long>> report,
