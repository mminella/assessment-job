 ...
 */
@Component public class ClosedAsDuplicatePerMonthTasklet extends BaseGithubSearchTasklet {

    public ClosedAsDuplicatePerMonthTasklet(RestOperations restTemplate, Map<ReportKey, List<Long>> report,
